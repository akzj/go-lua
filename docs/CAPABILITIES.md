...
| Test status | **All 29 official Lua 5.5.1 test suites PASS** |
...
**Summary**: The GC is functionally complete and passes all 29 official test suites. Incremental and generational modes are accepted by the API but internally run full collection cycles. This is transparent to Lua code — the API contract is honored.
