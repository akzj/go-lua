// Package api defines the Lua string library interface.
...
// =============================================================================
// String Library Interface
// =============================================================================

// StringLib provides Lua string library functions (string.len, string.find, etc.).
//
// Invariants:
// - Open() registers functions in the global table under "string"
...
type StringLib interface {
	// Open opens the string library, registering its functions.
	// L: the Lua state to operate on
	// Returns: number of values pushed onto the stack (always 1 = the module table)
	//
	// Side effects: sets global variable "string" with all string functions
	Open(L LuaAPI) int
}
